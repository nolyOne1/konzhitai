...
export function AuditPage() {
  ...
  useEffect(() => {
    let active = true
    setLoading(true)
    Promise.all([getAuditEvents({ targetType, targetId }), getAlerts()]).then(([auditEvents, systemAlerts]) => {
      if (!active) return
